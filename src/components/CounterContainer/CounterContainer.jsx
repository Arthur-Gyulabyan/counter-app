      ...
      <div className="wrapper">
        <div className="input-container">
          <InputNumber
            name="Max Value"
            id="max-value"
            defaultValue={this.state.maxCount}
            handler={this.setMaxCount}
          />
          <InputNumber
            name="Min Value"
            id="min-value"
            defaultValue={this.state.minCount}
            handler={this.setMinCount}
          />
          <InputNumber
            name="Step"
            id="step"
            defaultValue={this.state.step}
            handler={this.setStep}
          />
        </div>
        ...
        <div className="button-container">
          <Button handler={this.increaseCounter} btnText="Increase" />
          <Button handler={this.decreaseCounter} btnText="Decrease" />
          <Button handler={this.resetCounter} btnText="Reset" />
        </div>
      </div>
    );
  }
